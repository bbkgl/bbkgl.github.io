...
![1596551023795](https://raw.githubusercontent.com/bbkgl/bbkgl.github.io/master/cloud_img/1596551023795.png)

也可以通过地址偏移找到虚函数表首地址：

![1596551270029](https://raw.githubusercontent.com/bbkgl/bbkgl.github.io/master/cloud_img/1596551270029.png)

然后通过符号表+代码段首地址，计算出每个虚函数的地址。

首先给出代码段首地址，命令`cat /proc/<pid>/maps | grep <可执行文件名字>`：

![1596551469794](https://raw.githubusercontent.com/bbkgl/bbkgl.github.io/master/cloud_img/1596551469794.png)
...
![1596551698843](https://raw.githubusercontent.com/bbkgl/bbkgl.github.io/master/cloud_img/1596551698843.png)
...
简单解释一下：首先根据a1指针获得对象的地址，然后根据对象的前8个字节存储了虚函数表首地址可以拿到虚函数表的首地址。表示为`vta`。

```cpp
vta = (void *)*(uintptr_t *)(void *)(uintptr_t)a1
```

然后根据虚函数表的前8个字节中存储了第一虚函数的首地址，
...
![1596552816890](https://raw.githubusercontent.com/bbkgl/bbkgl.github.io/master/cloud_img/1596552816890.png)
